...
pyant.plotting.gain_heatmap(rotated_beam, resolution=300, min_elevation=80.0, label='rotated')
pyant.plotting.gain_heatmap(azimuthal_beam, resolution=300, min_elevation=80.0, label='azimuthal')
pyant.plotting.show()
