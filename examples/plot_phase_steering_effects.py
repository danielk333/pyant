...
def make_steering_plot(
                k, phi0, G, 
                levels=14, symmetric=None, 
                corrected=True, ax=None,
            ):
...
def steering_plot(
                beam, 
                num_ph=301, num_az=501, 
                levels=14, symmetric=True, 
                corrected=True, ax=None,
            ):

    k, phi0, G = steering_gain(
        beam, 
        num_ph=num_ph, num_az=num_az, 
        symmetric=symmetric, corrected=corrected,
    )

    make_steering_plot(
        k, phi0, G, 
        levels=levels, symmetric=symmetric, 
        corrected=corrected, ax=ax,
    )
