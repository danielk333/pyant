...
def monte_carlo_sample_gain(beam, parameters, num, seed=None, vectorized=True):
...
def monte_carlo_integrate_gain_hemisphere(beam, parameters, num, seed=None, vectorized=True):
    ...
    A = np.pi
    G, _ = monte_carlo_sample_gain(beam, parameters, num, seed=seed, vectorized=vectorized)
